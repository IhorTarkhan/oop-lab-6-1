...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (username != null) {
            coffeeAdminRepository.findByUsername(username).ifPresent(u -> setContext(request, u));
            coffeeUserRepository.findByUsername(username).ifPresent(u -> setContext(request, u));
        }
